...
class swept_sine_input: public block{
 public:
    ...
    swept_sine_input(float myslope, float myamp, float mydeadtime=1, 
                     float myt_end=2, float myt_on=1);
...
class i2c_plant: public plant{
 public:
  ...
  i2c_plant(i2c_actuator *myact, i2c_sensor *mysense);// : plant ();// : plant(myact, mysense) {};
